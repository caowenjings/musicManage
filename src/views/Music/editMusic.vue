        ...
        <i-form class="loginFrom" ref="formInline" :model="formInline" :rules="ruleInline" inline>
          ...
          <div class="info_item">
            ...
            <Form-item prop="musicaudio">
              ...
              <p v-else class="ios-cancel">
                已经上传
                <Icon type="ios-trash-outline" size="16" @click="cancelimg"></Icon>
              </p>
            </Form-item>
          </div>
          <div class="info_item">
...
export default {
  ...
  created() {
    ...
    this.formInline.musicsinger = data.singer;
    this.formInline.Album = data.album;
    this.formInline.musicLabel = data.description;
    this.formInline.musicaudio = data.url;
  ...
  methods: {
    ...
    cancelimg() {
      this.formInline.musicaudio = null;
    },
    handleSubmit(name) {
